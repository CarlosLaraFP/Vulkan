...
#include "Context.hpp" // Includes GLFW with Vulkan
...
{
public:
    VulkanApp(const uint32_t width, const uint32_t height) : windowWidth { width }, windowHeight { height }
    {
        context = std::make_unique<Context>(static_cast<int>(windowWidth), static_cast<int>(windowHeight), this);
        initVulkan();
    }
...
private:
    ...
    */
    ...
    void createSurface()
    {
        ...
        if (glfwCreateWindowSurface(instance, context->getWindow(), nullptr, &surface) != VK_SUCCESS)
        {
    ...
    */
    ...
    void cleanup()
    {
        ...
        // Context smart pointer destructor called automatically after the run method
    }
};
